...
${OBJECTDIR}/store_api.o: store_api.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/store_api.o store_api.c

${OBJECTDIR}/store_lib.o: store_lib.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/store_lib.o store_lib.c
...
${OBJECTDIR}/store_api_nomain.o: ${OBJECTDIR}/store_api.o store_api.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Wall -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/store_api_nomain.o store_api.c;\
	else  \
...
${OBJECTDIR}/store_lib_nomain.o: ${OBJECTDIR}/store_lib.o store_lib.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Wall -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/store_lib_nomain.o store_lib.c;\
	else  \
