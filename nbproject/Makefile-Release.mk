...
${OBJECTDIR}/file/file_api.o: file/file_api.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/file/file_api.o file/file_api.c

${OBJECTDIR}/file/file_lib.o: file/file_lib.c
	${MKDIR} -p ${OBJECTDIR}/file
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/file/file_lib.o file/file_lib.c

${OBJECTDIR}/html2txt/html2txt_api.o: html2txt/html2txt_api.c
	${MKDIR} -p ${OBJECTDIR}/html2txt
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/html2txt/html2txt_api.o html2txt/html2txt_api.c

${OBJECTDIR}/html2txt/html2txt_lib.o: html2txt/html2txt_lib.c
	${MKDIR} -p ${OBJECTDIR}/html2txt
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/html2txt/html2txt_lib.o html2txt/html2txt_lib.c

${OBJECTDIR}/list/list_api.o: list/list_api.c
	${MKDIR} -p ${OBJECTDIR}/list
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/list/list_api.o list/list_api.c

${OBJECTDIR}/list/list_lib.o: list/list_lib.c
	${MKDIR} -p ${OBJECTDIR}/list
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/list/list_lib.o list/list_lib.c

${OBJECTDIR}/log/log_api.o: log/log_api.c
	${MKDIR} -p ${OBJECTDIR}/log
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/log/log_api.o log/log_api.c

${OBJECTDIR}/log/log_lib.o: log/log_lib.c
	${MKDIR} -p ${OBJECTDIR}/log
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/log/log_lib.o log/log_lib.c

${OBJECTDIR}/mem/mem_api.o: mem/mem_api.c
	${MKDIR} -p ${OBJECTDIR}/mem
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mem/mem_api.o mem/mem_api.c

${OBJECTDIR}/mem/mem_lib.o: mem/mem_lib.c
	${MKDIR} -p ${OBJECTDIR}/mem
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mem/mem_lib.o mem/mem_lib.c

${OBJECTDIR}/queue/queue_api.o: queue/queue_api.c
	${MKDIR} -p ${OBJECTDIR}/queue
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/queue/queue_api.o queue/queue_api.c

${OBJECTDIR}/queue/queue_lib.o: queue/queue_lib.c
	${MKDIR} -p ${OBJECTDIR}/queue
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/queue/queue_lib.o queue/queue_lib.c

${OBJECTDIR}/sha1/sha1_api.o: sha1/sha1_api.c
	${MKDIR} -p ${OBJECTDIR}/sha1
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sha1/sha1_api.o sha1/sha1_api.c
...
${OBJECTDIR}/tcpip/tcpip_api.o: tcpip/tcpip_api.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tcpip/tcpip_api.o tcpip/tcpip_api.c

${OBJECTDIR}/tcpip/tcpip_lib.o: tcpip/tcpip_lib.c
	${MKDIR} -p ${OBJECTDIR}/tcpip
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tcpip/tcpip_lib.o tcpip/tcpip_lib.c

${OBJECTDIR}/text/text_api.o: text/text_api.c
	${MKDIR} -p ${OBJECTDIR}/text
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/text/text_api.o text/text_api.c

${OBJECTDIR}/text/text_lib.o: text/text_lib.c
	${MKDIR} -p ${OBJECTDIR}/text
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/text/text_lib.o text/text_lib.c

${OBJECTDIR}/thread/thread_api.o: thread/thread_api.c
	${MKDIR} -p ${OBJECTDIR}/thread
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thread/thread_api.o thread/thread_api.c

${OBJECTDIR}/thread/thread_lib.o: thread/thread_lib.c
	${MKDIR} -p ${OBJECTDIR}/thread
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thread/thread_lib.o thread/thread_lib.c

${OBJECTDIR}/token/token_api.o: token/token_api.c
	${MKDIR} -p ${OBJECTDIR}/token
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/token/token_api.o token/token_api.c

${OBJECTDIR}/token/token_lib.o: token/token_lib.c
	${MKDIR} -p ${OBJECTDIR}/token
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/token/token_lib.o token/token_lib.c
...
${TESTDIR}/file/tests/TEST__text_atox.o: file/tests/TEST__text_atox.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -Iinclude -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/file/tests/TEST__text_atox.o file/tests/TEST__text_atox.c
...
${OBJECTDIR}/file/file_api_nomain.o: ${OBJECTDIR}/file/file_api.o file/file_api.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/file/file_api_nomain.o file/file_api.c;\
	else  \
...
${OBJECTDIR}/file/file_lib_nomain.o: ${OBJECTDIR}/file/file_lib.o file/file_lib.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/file/file_lib_nomain.o file/file_lib.c;\
	else  \
...
${OBJECTDIR}/html2txt/html2txt_api_nomain.o: ${OBJECTDIR}/html2txt/html2txt_api.o html2txt/html2txt_api.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/html2txt/html2txt_api_nomain.o html2txt/html2txt_api.c;\
	else  \
...
${OBJECTDIR}/html2txt/html2txt_lib_nomain.o: ${OBJECTDIR}/html2txt/html2txt_lib.o html2txt/html2txt_lib.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/html2txt/html2txt_lib_nomain.o html2txt/html2txt_lib.c;\
	else  \
...
${OBJECTDIR}/list/list_api_nomain.o: ${OBJECTDIR}/list/list_api.o list/list_api.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/list/list_api_nomain.o list/list_api.c;\
	else  \
...
${OBJECTDIR}/list/list_lib_nomain.o: ${OBJECTDIR}/list/list_lib.o list/list_lib.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/list/list_lib_nomain.o list/list_lib.c;\
	else  \
...
${OBJECTDIR}/log/log_api_nomain.o: ${OBJECTDIR}/log/log_api.o log/log_api.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/log/log_api_nomain.o log/log_api.c;\
	else  \
...
${OBJECTDIR}/log/log_lib_nomain.o: ${OBJECTDIR}/log/log_lib.o log/log_lib.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/log/log_lib_nomain.o log/log_lib.c;\
	else  \
...
${OBJECTDIR}/mem/mem_api_nomain.o: ${OBJECTDIR}/mem/mem_api.o mem/mem_api.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mem/mem_api_nomain.o mem/mem_api.c;\
	else  \
...
${OBJECTDIR}/mem/mem_lib_nomain.o: ${OBJECTDIR}/mem/mem_lib.o mem/mem_lib.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/mem/mem_lib_nomain.o mem/mem_lib.c;\
	else  \
...
${OBJECTDIR}/queue/queue_api_nomain.o: ${OBJECTDIR}/queue/queue_api.o queue/queue_api.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/queue/queue_api_nomain.o queue/queue_api.c;\
	else  \
...
${OBJECTDIR}/queue/queue_lib_nomain.o: ${OBJECTDIR}/queue/queue_lib.o queue/queue_lib.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/queue/queue_lib_nomain.o queue/queue_lib.c;\
	else  \
...
${OBJECTDIR}/sha1/sha1_api_nomain.o: ${OBJECTDIR}/sha1/sha1_api.o sha1/sha1_api.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sha1/sha1_api_nomain.o sha1/sha1_api.c;\
	else  \
...
${OBJECTDIR}/sha1/sha1_lib_nomain.o: ${OBJECTDIR}/sha1/sha1_lib.o sha1/sha1_lib.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sha1/sha1_lib_nomain.o sha1/sha1_lib.c;\
	else  \
...
${OBJECTDIR}/tcpip/tcpip_api_nomain.o: ${OBJECTDIR}/tcpip/tcpip_api.o tcpip/tcpip_api.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tcpip/tcpip_api_nomain.o tcpip/tcpip_api.c;\
	else  \
...
${OBJECTDIR}/tcpip/tcpip_lib_nomain.o: ${OBJECTDIR}/tcpip/tcpip_lib.o tcpip/tcpip_lib.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tcpip/tcpip_lib_nomain.o tcpip/tcpip_lib.c;\
	else  \
...
${OBJECTDIR}/text/text_api_nomain.o: ${OBJECTDIR}/text/text_api.o text/text_api.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/text/text_api_nomain.o text/text_api.c;\
	else  \
...
${OBJECTDIR}/text/text_lib_nomain.o: ${OBJECTDIR}/text/text_lib.o text/text_lib.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/text/text_lib_nomain.o text/text_lib.c;\
	else  \
...
${OBJECTDIR}/thread/thread_api_nomain.o: ${OBJECTDIR}/thread/thread_api.o thread/thread_api.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thread/thread_api_nomain.o thread/thread_api.c;\
	else  \
...
${OBJECTDIR}/thread/thread_lib_nomain.o: ${OBJECTDIR}/thread/thread_lib.o thread/thread_lib.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/thread/thread_lib_nomain.o thread/thread_lib.c;\
	else  \
...
${OBJECTDIR}/token/token_api_nomain.o: ${OBJECTDIR}/token/token_api.o token/token_api.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/token/token_api_nomain.o token/token_api.c;\
	else  \
...
${OBJECTDIR}/token/token_lib_nomain.o: ${OBJECTDIR}/token/token_lib.o token/token_lib.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/token/token_lib_nomain.o token/token_lib.c;\
	else  \
